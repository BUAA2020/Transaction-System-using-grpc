...
// int64 number = 3;
inline void searchUserRsq_baggood::clear_number() {
  number_ = int64_t{0};
}
inline ::PROTOBUF_NAMESPACE_ID::int64 searchUserRsq_baggood::_internal_number() const {
  return number_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 searchUserRsq_baggood::number() const {
  // @@protoc_insertion_point(field_get:myApplication.searchUserRsq.baggood.number)
  return _internal_number();
}
inline void searchUserRsq_baggood::_internal_set_number(::PROTOBUF_NAMESPACE_ID::int64 value) {
  
  number_ = value;
}
inline void searchUserRsq_baggood::set_number(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _internal_set_number(value);
  // @@protoc_insertion_point(field_set:myApplication.searchUserRsq.baggood.number)
}
